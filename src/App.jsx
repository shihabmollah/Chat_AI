  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyBmCTCODDldbdEJac-RkyXHXjCRVTfjjr8`,
        method: "post",
        data: {
    ...
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 h-screen p-3 flex flex-col justify-center items-center">
      ...
      >
        <a href="https://github.com/shihabmollah" target="_blank" rel="noopener noreferrer">
          <h1 className="text-4xl font-bold text-blue-500 mb-4 animate-bounce">CHALO PUCHO</h1>
        </a>
        <textarea
          required
